    ...
    return (
            <div className={style.wrapper}>
                ...
                <div className={style.bodyhome}>
                    ...
                    <h3 className={style.textWhatTheySay}>What's They Says
                        ...
                        <div className={style.whattheysay_row}>
                            ...
                            <div className={style.whattheysay_3column}>
                                <div  className={style.whattheysay_background1}>
                                    <h3 class={style.whattheysayheading}>Fast Delivey</h3>
                                    <p class={style.whattheysaytext}>“I always shopping at Fruity via website and they offer fast delivery service ”</p>
                                    <img src={images.hinh1} className={style.whattheysayimage} alt='hinh1'/>
                                    <p class={style.whattheysaycustomer}>Tyler Alcacea <div className={style.whattheysaycustomer_opacity}>Toronto CA</div></p>
                                </div>
                            </div>
                            ...
                            <div className={style.whattheysay_3column}>
                                <div  className={style.whattheysay_background2}>
                                    <h3 class={style.whattheysayheading}>Freshness</h3>
                                    <p class={style.whattheysaytext}>“All fruits was fresh and organic . It’s free and 100% from our local farmers”</p>
                                    <img src={images.hinh1} className={style.whattheysayimage} alt='hinh1'/>
                                    <p class={style.whattheysaycustomer}>Tyler Alcacea <div className={style.whattheysaycustomer_opacity}>Toronto CA</div></p>
                                </div>
                            </div>
                            ...
                            <div className={style.whattheysay_3column}>
                                <div  className={style.whattheysay_background3}>
                                    <h3 class={style.whattheysayheading}>Multi PayMent</h3>
                                    <p class={style.whattheysaytext}>“Really love the app when Fruity offers me a discount for new comer”</p>
                                    <img src={images.hinh1} className={style.whattheysayimage} alt='hinh1'/>
                                    <p class={style.whattheysaycustomer}>Tyler Alcacea <div className={style.whattheysaycustomer_opacity}>Toronto CA</div></p>
                                </div>
                            </div>
                    ...
                    <div className={style.contact}>
                            ...
                            <div className={style.contact_content}>
                                    ...
                                    <p className={style.contact_text}>Join our mailing list to get offers, discounts and other news frequently by fill your e-mail below.</p>
                                    <input placeholder='Type your E-Mail' className={style.contact_input}></input>
                                    <Button to='/contact' small  className={style.btnSubmit}> Yes I do </Button>
                            </div>
                    </div>
